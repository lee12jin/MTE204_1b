...
% 
% [u_solved1, v_solved1, a_solved1, f_solved1] = apply_explicit_dynamic_formulation(A_t1, B_t1, D_t1, u0, u_unknown, v0, a0, f_unknown, t, time_step1, n, unknown);
% [u_solved2, v_solved2, a_solved2, f_solved2] = apply_explicit_dynamic_formulation(A_t2, B_t2, D_t2, u0, u_unknown, v0, a0, f_unknown, t, time_step2, n, unknown);
% [u_solved3, v_solved3, a_solved3, f_solved3] = apply_explicit_dynamic_formulation(A_t3, B_t3, D_t3, u0, u_unknown, v0, a0, f_unknown, t, time_step3, n, unknown);
...
[u_solved1, v_solved1, a_solved1, f_solved1] = apply_implicit_dynamic_formulation(A_t1, B_t1, C_t1, D_t1, u0, u_unknown, v0, a0, f_unknown, beta, gamma, t, time_step1, n);
[u_solved2, v_solved2, a_solved2, f_solved2] = apply_implicit_dynamic_formulation(A_t2, B_t2, C_t2, D_t2, u0, u_unknown, v0, a0, f_unknown, beta, gamma, t, time_step2, n);
[u_solved3, v_solved3, a_solved3, f_solved3] = apply_implicit_dynamic_formulation(A_t3, B_t3, C_t3, D_t3, u0, u_unknown, v0, a0, f_unknown, beta, gamma, t, time_step3, n);
